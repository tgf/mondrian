...
public class CompoundSlicerTest extends FoodMartTestCase {
    ...
    /**
     * Test for <a href="http://jira.pentaho.com/browse/MONDRIAN-1128">
     * Bug MONDRIAN-1128,
     * "Add support to sets in RolapNativeTopCount"</a>
     */
    public void testTopCountAllSlicers() {
        ...
        "Axis #0:\n"
        + "{[Time].[Time].[1997].[Q1].[2], [Product].[Products].[All Products]}\n"
        + "{[Time].[Time].[1997].[Q1].[3], [Product].[Products].[All Products]}\n"
        + "Axis #1:\n"
        + "{[Measures].[Unit Sales]}\n"
        + "Axis #2:\n"
        + "{[Customer].[Customers].[USA].[WA].[Spokane].[Grace McLaughlin]}\n"
    ...
    public void testTopCountWithAggregatedMember2() {
        assertQueryReturns(
            "with\n"
            + "member Time.Time.x as Aggregate([Time].[1997].[Q1] : [Time].[1997].[Q2], [Measures].[Store Sales])\n"
            + "member Measures.x1 as ([Time].[1997].[Q1], [Measures].[Store Sales])\n"
            + "member Measures.x2 as ([Time].[1997].[Q2], [Measures].[Store Sales])\n"
            + " set products as TopCount(Product.[Product Name].Members, 2, Measures.[Store Sales])\n"
            + " SELECT NON EMPTY products ON 1,\n"
    ...
    public void testTopCountWithAggregatedMemberCacheKey() {
        ...
        assertQueryReturns(
            "with\n"
            + "member Time.Time.x as Aggregate(Union({[Time].[1997].[Q4]},[Time].[1997].[Q1] : [Time].[1997].[Q2]),[Measures].[Store Sales]) \n"
            + "member Measures.x1 as ([Time].[1997].[Q1],[Measures].[Store Sales]) \n"
            + "member Measures.x2 as ([Time].[1997].[Q2],[Measures].[Store Sales]) \n"
            + " set products as TopCount(Product.[Product Name].Members,2,(Measures.[Store Sales]))\n"
            + " SELECT NON EMPTY products ON 1, \n"
