...
public class BasicQueryTest extends FoodMartTestCase {
    ...
    public void testExplain() throws SQLException {
        ...
        TestContext.assertEqualsVerbose(
            "Axis (COLUMNS):\n"
            + "MemberListIterCalc(name=MemberListIterCalc, class=class mondrian.calc.impl.AbstractExpCompiler$MemberListIterCalc, type=SetType<MemberType<member=[Measures].[Unit Sales]>>, resultStyle=ITERABLE)\n"
            + "    MemberSetListCalc(name=MemberSetListCalc, class=class mondrian.olap.fun.SetFunDef$MemberSetListCalc, type=SetType<MemberType<member=[Measures].[Unit Sales]>>, resultStyle=MUTABLE_LIST)\n"
            + "        Sublist(name=Sublist, class=class mondrian.olap.fun.SetFunDef$MemberSetListCalc$2, type=MemberType<member=[Measures].[Unit Sales]>, resultStyle=VALUE)\n"
    ...
    public void testExplainComplex() throws SQLException {
        ...
        TestContext.assertEqualsVerbose(
            "Axis (FILTER):\n"
            + "MemberListIterCalc(name=MemberListIterCalc, class=class mondrian.calc.impl.AbstractExpCompiler$MemberListIterCalc, type=SetType<MemberType<member=[Gender].[F]>>, resultStyle=ITERABLE)\n"
            + "    MemberSetListCalc(name=MemberSetListCalc, class=class mondrian.olap.fun.SetFunDef$MemberSetListCalc, type=SetType<MemberType<member=[Gender].[F]>>, resultStyle=MUTABLE_LIST)\n"
            + "        Sublist(name=Sublist, class=class mondrian.olap.fun.SetFunDef$MemberSetListCalc$2, type=MemberType<member=[Gender].[F]>, resultStyle=VALUE)\n"
            ...
            + "        Sublist(name=Sublist, class=class mondrian.olap.fun.SetFunDef$MemberSetListCalc$2, type=MemberType<member=[Measures].[Unit Sales]>, resultStyle=VALUE)\n"
            + "            Literal(name=Literal, class=class mondrian.calc.impl.ConstantCalc, type=MemberType<member=[Measures].[Unit Sales]>, resultStyle=VALUE_NOT_NULL, value=[Measures].[Unit Sales])\n"
            + "        Sublist(name=Sublist, class=class mondrian.olap.fun.SetFunDef$MemberSetListCalc$2, type=MemberType<member=[Measures].[Store Margin]>, resultStyle=VALUE)\n"
            ...
            + "\n"
            + "Axis (ROWS):\n"
            + "IterMemberListMemberIterCalc(name=IterMemberListMemberIterCalc, class=class mondrian.olap.fun.CrossJoinFunDef$IterMemberListMemberIterCalc, type=SetType<TupleType<MemberType<member=[Product].[Drink]>, MemberType<hierarchy=[Marital Status]>>>, resultStyle=ITERABLE)\n"
            + "    2(name=2, class=class mondrian.mdx.NamedSetExpr$2, type=SetType<MemberType<member=[Product].[Drink]>>, resultStyle=ITERABLE)\n"
