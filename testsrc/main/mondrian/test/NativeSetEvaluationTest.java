...
public class NativeSetEvaluationTest extends BatchTestCase {
    ...
    public void testNativeTopCountWithMemberOnlySlicer() {
        ...
        final String mdx =
            ...
            + "  MEMBER [Time].[Time].[Slicer] as [Time].[1997]\n"
            + "  MEMBER [Store Type].[Store Type].[Slicer] as [Store Type].[Store Type].[Deluxe Supermarket]\n"
            + "\n"
        ...
        getTestContext().legacy().assertQueryReturns(
            mdx,
            "Axis #0:\n"
    ...
    public void testNativeTopCountWithParenthesesMemberSlicer() {
        ...
        final String mdx =
            ...
            + "  SELECT NON EMPTY [Measures].[Unit Sales] on 0,\n"
            + "    TC ON 1 \n"
            + "  FROM [Sales] WHERE {([Time].[Slicer], [Store Type].[Store Type].[Slicer])}\n";
        ...
        TestContext context = getTestContext().legacy();
        SqlPattern mysqlPattern =
            new SqlPattern(
                DatabaseProduct.MYSQL,
                mysqlQuery,
    ...
    public void testNativeTopCountWithMemberSumSlicer() {
        ...
        final String mdx =
            ...
            + "  SET TC AS 'TopCount([Product].[Drink].[Alcoholic Beverages].Children, 3, [Measures].[Unit Sales] )'\n"
            + "  MEMBER [Time].[Time].[Slicer] as [Time].[1997]\n"
            + "  MEMBER [Store Type].[Store Type].[Slicer] as [Store Type].[Store Type].[Deluxe Supermarket] + [Store Type].[Store Type].[Gourmet Supermarket]\n"
            + "\n"
            + "  SELECT NON EMPTY [Measures].[Unit Sales] on 0,\n"
            + "    TC ON 1 \n"
            + "  FROM [Sales] WHERE {([Time].[Slicer], [Store Type].[Slicer])}\n";
    ...
    public void testLoopDetection() {
        ...
        assertQueryThrows(mdx, "Infinite loop");
    }
    ...
    public void testSlicerTuplesPartialCrossJoin() {
        ...
        getTestContext().legacy().assertQueryReturns(mdx, result);
    }
    ...
    public void testMultipleAllWithInExpr() {
        ...
        final String mdx =
            "with member [AltStore.AltStore].[AllSlicer] as 'Aggregate({[AltStore].[All]})'\n"
        ...
        String result =
            ...
            + "{[Product].[Product].[Non-Consumable].[Health and Hygiene].[Bathroom Products].[Mouthwash].[Hilltop].[Hilltop Mint Mouthwash]}\n"
            + "Row #0: 51.60\n"
            + "Row #1: 28.96\n";
        TestContext context =
    ...
    public void testCompoundSlicerNativeEval() {
        ...
        assertQueryReturns(
            ...
            + "{[Time].[Time].[1997].[Q3]}\n"
            + "Axis #1:\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Dennis Messer]}\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Esther Logsdon]}\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Karen Moreland]}\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Kent Brant]}\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Louise Wakefield]}\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Reta Mikalas]}\n"
            + "{[Customer].[Customers].[USA].[CA].[San Francisco].[Tammy Mihalek]}\n"
            + "Row #0: 8\n"
            + "Row #0: 3\n"
            + "Row #0: 13\n"
            + "Row #0: 5\n"
    ...
    public void testSnowflakeDimInSlicerBug1407() {
        ...
        assertQueryReturns(
            mdx,
            "Axis #0:\n"
            + "{[Time].[Time].[1997], [Product].[Products].[Drink]}\n"
            + "{[Time].[Time].[1997], [Product].[Products].[Food]}\n"
            + "Axis #1:\n"
            + "{[Customer].[Customers].[USA].[WA].[Spokane].[Mary Francis Benigar]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Spokane].[James Horvat]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Spokane].[Wildon Cameron]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Spokane].[Ida Rodriguez]}\n"
    ...
    public void testCompoundSlicerNonUniqueMemberNames1413() {
        ...
        assertQueryReturns(
            ...
            + "Axis #1:\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[Joanne Skuderna]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Yakima].[Paula Stevens]}\n"
            + "{[Customer].[Customers].[USA].[WA].[Everett].[Sarah Miller]}\n"
            + "{[Customer].[Customers].[USA].[OR].[Albany].[Kathryn Chamberlin]}\n"
            + "{[Customer].[Customers].[USA].[OR].[Salem].[Scott Pavicich]}\n"
            + "Row #0: 37\n"
            + "Row #0: 32\n"
            + "Row #0: 29\n"
            + "Row #0: 28\n"
